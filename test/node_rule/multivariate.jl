module TestMultivariateNode
    ...
    @testset "MultivariateSGPNode" begin
        method = srcubature()
        θ_val = [1.,1.] 
        Nu_2d = 25
        ...
        Ψ2_func = (x) -> kernelmatrix(kernel(θ_val), Xu_2d, [x]) * kernelmatrix(kernel(θ_val), [x], Xu_2d) + 1e-12I
        ...
        Ψ2_gt = mean(Ψ2_func.(sample_x)) + 1e-12*I
        ...
        @testset "Test out rule" begin
            ...
            #q_in :: PointMass is missing
        end

        #--------------#
        @testset "Test in rule" begin
            #q_out :: MvNormal, q_W::Wishart
            ...
            #q_out::PointMass, q_in::MvNormal, q_w::PointMass
        ...
        @testset "Test v rule" begin
            # q_out, q_in :: MvNormal, q_W :: Wishart 
            ...
            # q_out :: PiontMass, q_in :: MvNormal, q_w :: PointMass
            q_out_pm = PointMass([1.5,2.0])
            q_w_pm = PointMass(W_mean)
